...
export default async function Accueil() {
  ...
  const sousTitre =
    data?.sousTitre ||
    "Des créations florales uniques, composées avec passion à partir de fleurs de saison pour sublimer chaque instant.";
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary/10 via-cream to-secondary/10">
        ...
        <div className="relative mx-auto max-w-4xl px-6 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/catalogue"
              className="bg-primary text-white px-8 py-4 rounded-full font-medium hover:bg-primary-light transition-all duration-300 hover:shadow-lg hover:shadow-primary/20"
            >
              D&eacute;couvrir nos cr&eacute;ations
            </Link>
            <Link
              href="/a-propos"
              className="border border-primary/30 text-primary px-8 py-4 rounded-full font-medium hover:bg-primary/5 transition-all duration-300"
            >
              Notre histoire
            </Link>
          </div>
            ...
            {[
              {
                ...
                text: "Nous travaillons exclusivement avec des fleurs fra\u00eeches et de saison, s\u00e9lectionn\u00e9es aupr\u00e8s de producteurs locaux.",
              },
              {
                icon: "\u{2702}\u{FE0F}",
                title: "Fait main",
                text: "Chaque bouquet est compos\u00e9 \u00e0 la main dans notre atelier parisien, avec soin et cr\u00e9ativit\u00e9.",
              },
              {
                icon: "\u{1F49A}",
                title: "\u00c9co-responsable",
                text: "Emballages recycl\u00e9s, circuits courts et z\u00e9ro mousse florale synth\u00e9tique pour un impact minimal.",
              },
            ].map((item) => (
      ...
      <section className="py-20 md:py-28">
        <div className="mx-auto max-w-6xl px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            {data?.introduction ? (
              <div className="mt-6">
                <PortableTextRenderer value={data.introduction} />
              </div>
            ) : (
              <p className="mt-6 text-charcoal/60 leading-relaxed">
                N&eacute; d&rsquo;une passion pour la beaut&eacute;
                &eacute;ph&eacute;m&egrave;re des fleurs, Atelier Flora est un
                espace de cr&eacute;ation o&ugrave; chaque composition raconte une
                histoire. Nous croyons que les fleurs ont le pouvoir
                d&rsquo;&eacute;veiller les sens et d&rsquo;accompagner vos
                moments les plus pr&eacute;cieux.
              </p>
            )}
            <Link
              href="/a-propos"
              className="mt-8 inline-flex items-center gap-2 text-primary font-medium hover:gap-3 transition-all duration-300"
            >
              En savoir plus
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {produitsVedettes.length > 0
              ...
              : [
                  { name: "Bouquet Aurore", price: "45" },
                  { name: "Composition Jardin Secret", price: "65" },
                  { name: "Bouquet Ros\u00e9e du Matin", price: "55" },
                ].map((product) => (
                  <div key={product.name} className="group cursor-pointer">
                    <div className="aspect-[3/4] rounded-2xl bg-gradient-to-br from-primary/5 to-secondary/10 flex items-center justify-center overflow-hidden relative">
                      <span className="text-charcoal/30 text-sm">
                        Photo produit
                      </span>
                      <div className="absolute inset-0 bg-primary/0 group-hover:bg-primary/10 transition-all duration-500" />
      ...
      <section className="py-20 md:py-28 bg-gradient-to-r from-primary to-primary-light text-white">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <h2 className="font-serif text-3xl md:text-4xl leading-tight">
            Un &eacute;v&eacute;nement &agrave; fleurir ?
          </h2>
          <p className="mt-4 text-white/80 text-lg">
            Mariage, anniversaire ou simplement envie de faire plaisir &mdash;
